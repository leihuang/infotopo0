...
net.add_reaction_ma('R1', stoich_or_eqn='X1<->S', p={'kf':1,'KE':1}, haldane='kf', add_thermo=False)
net.add_reaction_ma('R2', stoich_or_eqn='S<->X2', p={'kf':1,'KE':1}, haldane='kf', add_thermo=False)
