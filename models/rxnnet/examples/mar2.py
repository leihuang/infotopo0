...
net0 = model.Network(id='MAR2_standard')
...
net0.add_reaction_ma('R1', stoich_or_eqn='A1<->X', p={'kf':1,'KE':1}, haldane='kf', add_thermo=False)
net0.add_reaction_ma('R2', stoich_or_eqn='X<->A2', p={'kf':1,'KE':1}, haldane='kf', add_thermo=False)
...
net.add_reaction('R1', stoich_or_eqn='<->X', ratelaw='k1*(A1-X)', p={'k1':1})
net.add_reaction('R2', stoich_or_eqn='X<->', ratelaw='k2*(X-A2)', p={'k2':1})
