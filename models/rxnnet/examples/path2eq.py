...
for rxn in net2.reactions:
    if rxn.kineticLaw == '0':
        subids = models._get_substrates(rxn.stoichiometry, multi=True)
        proids = models._get_products(rxn.stoichiometry, multi=True)
